          ...
          <div className="rounded-2xl border border-white/[0.06] bg-[#0d1117] p-5 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:border-indigo-500 transition-colors [color-scheme:dark]"
              />
            </div>
