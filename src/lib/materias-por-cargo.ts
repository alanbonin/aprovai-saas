...
export const MATERIAS_POR_CARGO: Record<string, MateriasCargo> = {
  ...
  "ti-tcu":   { materias: ["Língua Portuguesa","Raciocínio Lógico","Banco de Dados","Redes de Computadores","Segurança da Informação","Engenharia de Software","Governança de TI","Algoritmos e Estruturas de Dados","Controle Externo e TCU","Auditoria Governamental","Legislação Específica"], observacoes: "Banca FGV/CESPE. TI com foco em auditoria de sistemas governamentais." },
